...
WHAT THIS STAGE DOES. `placer/core/breakpoints.py` enumerates candidate
...
def collect_hypothesis_validator_evidence(summary: HypothesisSummary,
    ...
    """
    from placer.core.segmentation import has_identifiable_bilateral_partial_context_support
