...
`placer/core/genotype.py` left behind -- and pinned by
...
`_is_one_sided_segmentation_pass` in `placer/core/blocks.py`.
"""
...
from placer.core import blocks as blocks_module
from placer.core import mathx
from placer.core import structure as structure_module
from placer.core.explanation import (
    EventExplanation,
    ExplanationDecision,
    ExplanationKind,
...
def is_one_sided_segmentation_pass(segmentation: EventSegmentationEvidence) -> bool:
    ...
    `placer.core.blocks._is_one_sided_segmentation_pass`) requires `NOT
...
def te_alignment_log_support(te_alignment) -> float:
    ...
    total across this file, which is precisely what `placer/core/blocks.py`'s
...
# has to be declared. See placer/core/explanation.py for the comparison itself.
# --------------------------------------------------------------------------
