...
and one sequence) and otherwise raises. `placer/core/consensus.py` documents the
options.
"""
...
from placer.core.fragments import InsertionFragment, InsertionFragmentSource, ReferenceSide
from placer.core.windows import LONG_INSERTION_SIGNAL_MIN, SOFT_CLIP_SIGNAL_MIN
