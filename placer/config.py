...
class PipelineConfig:
    ...
    #: output: `placer/parallel.py` splits the scan into bin-aligned chunks
    ...
    #: gets a `blastn` of its own (see `placer/io/te_library.py`).
    te_blast_jobs: int = 0
    ...
    #: either to 0 to require exact TSDs, as the C++ PLACER's releases before
    #: its 0.0.5 did. That is the C++ project's numbering; this package's
    #: first release is 1.0.
