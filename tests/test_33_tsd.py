...
THIS FILE EXISTS BECAUSE THE DETECTOR HAD NO TEST. `placer/core/tsd.py`'s
...
from placer.core.tsd import TsdConfig, detect, detect_from_insertion, fetcher_from_string
